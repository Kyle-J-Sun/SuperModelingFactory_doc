...
- :material-tag: **[v0.7.0](v0.7.0.md)** - Default-governance flip: real OOT boundaries, WOE fit ordering, refined-bin warnings, unified gains direction, and categorical VIF support
